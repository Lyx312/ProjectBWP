        ...
        @foreach ($order as $orders)
            <div class="card mt-5">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">Total Price: Rp. {{ number_format($orders->order_total, 0, ",", ".") }}</p>
                        ...
                        <tbody>
                            @foreach ($orders->OrderDetail as $index => $detail)
                                <tr>
                                    ...
                                    <td>Rp. {{ number_format($detail->detail_subtotal, 0, ",", ".") }}</td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
    ...
    <div class="card-rows mx-3 mb-3">
        @foreach ($customers as $customer)
            <div class="card mt-5">
                ...
                <div class="card-body">
                    <p class="card-text">Total Spending: Rp. {{ number_format($customer->Order->sum('order_total'), 0, ",", ".") }}</p>
                            ...
                            <tbody>
                                @foreach ($customer->OrderDetail as $index => $orderDetail)
                                    <tr>
                                        ...
                                        <td>Rp. {{ number_format($orderDetail->detail_subtotal, 0, ",", ".") }}</td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
